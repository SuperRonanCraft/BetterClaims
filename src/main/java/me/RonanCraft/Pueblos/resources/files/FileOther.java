...
public class FileOther {
    ...
    public enum FILETYPE {
        ...
        FILETYPE(String str) {
            ...
            this.file = new File(Pueblos.getInstance().getDataFolder(), fileName);
        }
        ...
        private void load() {
            if (!file.exists()) {
                Pueblos.getInstance().saveResource(fileName, false);
                try {
                    config.load(file);
                } catch (Exception e) {
                    e.printStackTrace();
                ...
                try {
                    config.load(file);
                    final InputStream in = Pueblos.getInstance().getResource(fileName);
                    if (in != null) {

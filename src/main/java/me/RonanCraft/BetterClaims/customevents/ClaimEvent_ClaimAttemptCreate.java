...
public class ClaimEvent_ClaimAttemptCreate extends ClaimEventType_ClaimCancellable {
     ...
     */
    public ClaimEvent_ClaimAttemptCreate(ClaimData claimData, Player creator) {
